...
for(c in a)g&&"prototype"==c||!h.call(a,c)||b(c);for(e=d.length;c=d[--e];h.call(a,c)&&b(c));}),p(a,b)},!c("json-stringify")){var E={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},F="000000",G=function(a,b){return(F+(b||0)).slice(-a)},H="\\u00",I=function(a){for(var b='"',c=0,d=a.length,e=!A||d>10,f=e&&(A?a.split(""):a);c<d;c++){var g=a.charCodeAt(c);switch(g){case 8:case 9:case 10:case 12:case 13:case 34:case 92:b+=E[g];break;default:if(g<32){b+=H+G(2,g.toString(16));break}b+=e?f[c]:a.charAt(c)}}return b+'"'},J=function(a,b,c,d,e,f,g){var h,i,j,k,m,n,r,t,u,A,C,E,F,H,K,L;try{h=b[a]}catch(a){}if("object"==typeof h&&h)if(i=s.call(h),i!=v||o.call(h,"toJSON"))"function"==typeof h.toJSON&&(i!=w&&i!=x&&i!=y||o.call(h,"toJSON"))&&(h=h.toJSON(a));else if(h>-1/0&&h<1/0){if(D){for(m=B(h/864e5),j=B(m/365.2425)+1970-1;D(j+1,0)<=m;j++);for(k=B((m-D(j,0))/30.42);D(j,k+1)<=m;k++);m=1+m-D(j,k),n=(h%864e5+864e5)%864e5,r=B(n/36e5)%24,t=B(n/6e4)%60,u=B(n/1e3)%60,A=n%1e3}else j=h.getUTCFullYear(),k=h.getUTCMonth(),m=h.getUTCDate(),r=h.getUTCHours(),t=h.getUTCMinutes(),u=h.getUTCSeconds(),A=h.getUTCMilliseconds();h=(j<=0||j>=1e4?(j<0?"-":"+")+G(6,j<0?-j:j):G(4,j))+"-"+G(2,k+1)+"-"+G(2,m)+"T"+G(2,r)+":"+G(2,t)+":"+G(2,u)+"."+G(3,A)+"Z"}else h=null;if(c&&(h=c.call(b,a,h)),null===h)return"null";if(i=s.call(h),i==z)return""+h;if(i==w)return h>-1/0&&h<1/0?""+h:"null";if(i==x)return I(""+h);if("object"==typeof h){for(H=g.length;H--;)if(g[H]===h)throw l();if(g.push(h),C=[],K=f,f+=e,i==y){for(F=0,H=h.length;F<H;F++)E=J(F,h,c,d,e,f,g),C.push(E===q?"null":E);L=C.length?e?"[\n"+f+C.join(",\n"+f)+"\n"+K+"]":"["+C.join(",")+"]":"[]"}else p(d||h,function(a){var b=J(a,h,c,d,e,f,g);b!==q&&C.push(I(a)+":"+(e?" ":"")+b)}),L=C.length?e?"{\n"+f+C.join(",\n"+f)+"\n"+K+"}":"{"+C.join(",")+"}":"{}";return g.pop(),L}};b.stringify=function(a,b,c){var d,e,g,h;if(f[typeof b]&&b)if((h=s.call(b))==u)e=b;else if(h==y){g={};for(var i,j=0,k=b.length;j<k;i=b[j++],h=s.call(i),(h==x||h==w)&&(g[i]=1));}if(c)if((h=s.call(c))==w){if((c-=c%1)>0)for(d="",c>10&&(c=10);d.length<c;d+=" ");}else h==x&&(d=c.length<=10?c:c.slice(0,10));return J("",(i={},i[""]=a,i),e,g,d,"",[])}}if(!c("json-parse")){var K,L,M=g.fromCharCode,N={92:"\\",34:'"',47:"/",98:"\b",116:"\t",110:"\n",102:"\f",114:"\r"},O=function(){throw K=L=null,k()},P=function(){for(var a,b,c,d,e,f=L,g=f.length;K<g;)switch(e=f.charCodeAt(K)){case 9:case 10:case 13:case 32:K++;break;case 123:case 125:case 91:case 93:case 58:case 44:return a=A?f.charAt(K):f[K],K++,a;case 34:for(a="@",K++;K<g;)if(e=f.charCodeAt(K),e<32)O();else if(92==e)switch(e=f.charCodeAt(++K)){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:a+=N[e],K++;break;case 117:for(b=++K,c=K+4;K<c;K++)e=f.charCodeAt(K),e>=48&&e<=57||e>=97&&e<=102||e>=65&&e<=70||O();a+=M("0x"+f.slice(b,K));break;default:O()}else{if(34==e)break;for(e=f.charCodeAt(K),b=K;e>=32&&92!=e&&34!=e;)e=f.charCodeAt(++K);a+=f.slice(b,K)}if(34==f.charCodeAt(K))return K++,a;O();default:if(b=K,45==e&&(d=!0,e=f.charCodeAt(++K)),e>=48&&e<=57){for(48==e&&(e=f.charCodeAt(K+1),e>=48&&e<=57)&&O(),d=!1;K<g&&(e=f.charCodeAt(K),e>=48&&e<=57);K++);if(46==f.charCodeAt(K)){for(c=++K;c<g&&(e=f.charCodeAt(c),e>=48&&e<=57);c++);c==K&&O(),K=c}if(e=f.charCodeAt(K),101==e||69==e){for(e=f.charCodeAt(++K),43!=e&&45!=e||K++,c=K;c<g&&(e=f.charCodeAt(c),e>=48&&e<=57);c++);c==K&&O(),K=c}return+f.slice(b,K)}if(d&&O(),"true"==f.slice(K,K+4))return K+=4,!0;if("false"==f.slice(K,K+5))return K+=5,!1;if("null"==f.slice(K,K+4))return K+=4,null;O()}return"$"},Q=function(a){var b,c;if("$"==a&&O(),"string"==typeof a){if("@"==(A?a.charAt(0):a[0]))return a.slice(1);if("["==a){for(b=[];a=P(),"]"!=a;c||(c=!0))c&&(","==a?(a=P(),"]"==a&&O()):O()),","==a&&O(),b.push(Q(a));return b}if("{"==a){for(b={};a=P(),"}"!=a;c||(c=!0))c&&(","==a?(a=P(),"}"==a&&O()):O()),","!=a&&"string"==typeof a&&"@"==(A?a.charAt(0):a[0])&&":"==P()||O(),b[a.slice(1)]=Q(P());return b}O()}return a},R=function(a,b,c){var d=S(a,b,c);d===q?delete a[b]:a[b]=d},S=function(a,b,c){var d,e=a[b];if("object"==typeof e&&e)if(s.call(e)==y)for(d=e.length;d--;)R(e,d,c);else p(e,function(a){R(e,a,c)});return c.call(a,b,e)};b.parse=function(a,b){var c,d;return K=0,L=""+a,c=Q(P()),"$"!=P()&&O(),K=L=null,b&&s.call(b)==u?S((d={},d[""]=c,d),"",b):c}}}return b.runInContext=d,b}var e="function"==typeof define&&define.amd,f={function:!0,object:!0},g=f[typeof c]&&c&&!c.nodeType&&c,h=f[typeof window]&&window||this,i=g&&f[typeof b]&&b&&!b.nodeType&&"object"==typeof a&&a;if(!i||i.global!==i&&i.window!==i&&i.self!==i||(h=i),g&&!e)d(h,g);else{var j=h.JSON,k=h.JSON3,l=!1,m=d(h,h.JSON3={noConflict:function(){return l||(l=!0,h.JSON=j,h.JSON3=k,j=k=null),m}});h.JSON={parse:m.parse,stringify:m.stringify}}e&&define(function(){return m})}).call(this)}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}],48:[function(a,b,c){function d(a,b){var c=[];b=b||0;for(var d=b||0;d<a.length;d++)c[d-b]=a[d];return c}b.exports=d},{}],49:[function(a,b,c){var d=a("./game_opts"),e=function(a,b,c,d){var e;for(this.qty=27,this.speed=20,this.color=c,this.rectangle=[],this.active=[],d?this.omit=[7,16,25]:this.omit=[1,10,19],startx=a,starty=b,dist=35,offsetBarrier=200,e=0;e<this.qty;e++)this.rectangle[e]={x:a,y:b,w:30,h:15},a+=dist,0!=e&&(e+1)%3==0&&(b+=dist/2,a=startx),0!=e&&(e+1)%9==0&&(a=startx+=offsetBarrier,b=starty);for(e=0;e<this.qty;e++)this.omit.indexOf(e)!=-1?this.active[e]=0:this.active[e]=1};e.prototype.moveX=function(a){a<0&&this.rectangle.x+a<0||a>0&&this.rectangle.x+this.rectangle.w+a>d.screenW||(this.rectangle.x+=a)},e.prototype.moveLeft=function(){this.moveX(-this.speed)},e.prototype.moveRight=function(){this.moveX(this.speed)},e.prototype.moveY=function(a){this.rectangle.y+=a},e.prototype.getX=function(){return this.rectangle.x},e.prototype.getY=function(){return this.rectangle.y},e.prototype.getW=function(){return this.rectangle.w},e.prototype.getH=function(){return this.rectangle.h},e.prototype.asignBullet=function(a){this.bullet=a},e.prototype.fire=function(){this.bullet.fire(this.getX()+this.getW()/2,this.getY())},e.prototype.draw=function(a){var b;for(b=0;b<this.qty;b++)1==this.active[b]&&(a.fillStyle=this.color,a.fillRect(this.rectangle[b].x,this.rectangle[b].y,this.rectangle[b].w,this.rectangle[b].h))},e.prototype.getState=function(){return{active:this.active}},e.prototype.setState=function(a){this.active=a.active},b.exports=e},{"./game_opts":53}],50:[function(a,b,c){var d=a("./game_opts"),e=function(a,b,c){this.rectangle={x:a,y:b,w:50,h:40},this.speed=20,this.color=c,this.bullet=!1,this.direction=0};e.prototype.moveX=function(a){a<0&&this.rectangle.x+a<0||a>0&&this.rectangle.x+this.rectangle.w+a>d.screenW||(this.rectangle.x+=a)},e.prototype.moveLeft=function(){this.moveX(-this.speed)},e.prototype.moveRight=function(){this.moveX(this.speed)},e.prototype.moveY=function(a){this.rectangle.y+=a},e.prototype.getX=function(){return this.rectangle.x},e.prototype.getY=function(){return this.rectangle.y},e.prototype.getW=function(){return this.rectangle.w},e.prototype.getH=function(){return this.rectangle.h},e.prototype.asignBullet=function(a){this.bullet=a},e.prototype.fire=function(){this.bullet.fire(this.getX()+this.getW()/2,this.getY())},e.prototype.draw=function(a){a.fillStyle=this.color,a.fillRect(this.getX(),this.getY(),this.getW(),this.getH())},e.prototype.getState=function(){return{x:this.rectangle.x,y:this.rectangle.y}},e.prototype.setState=function(a){this.rectangle.x=a.x,this.rectangle.y=a.y},b.exports=e},{"./game_opts":53}],51:[function(a,b,c){var d=a("./game_opts"),e=function(a,b,c){this.rectangle={x:a,y:b,w:10,h:25},this.speed=25,this.color=c,this.state=0};e.prototype.moveX=function(a){this.rectangle.x+=a},e.prototype.moveY=function(a){1==this.orientation?this.rectangle.y-=a:this.rectangle.y+=a},e.prototype.getX=function(){return this.rectangle.x},e.prototype.getY=function(){return this.rectangle.y},e.prototype.getW=function(){return this.rectangle.w},e.prototype.getH=function(){return this.rectangle.h},e.prototype.fire=function(a,b){0==this.state&&(this.position(a,b),this.state=1)},e.prototype.position=function(a,b){this.rectangle.x=a,this.rectangle.y=b},e.prototype.reset=function(){this.state=0,this.rectangle.x=-50,this.rectangle.y=-50},e.prototype.draw=function(a){1==this.state&&(a.fillStyle=this.color,a.fillRect(this.getX(),this.getY(),this.getW(),this.getH()))},e.prototype.getState=function(){return 1==this.state&&(this.getY()<d.screenH&&this.getY()>0?this.moveY(this.speed):this.reset()),{s:this.state,x:this.rectangle.x,y:this.rectangle.y}},e.prototype.setState=function(a){this.state=a.s,this.rectangle.x=a.x,this.rectangle.y=a.y},b.exports=e},{"./game_opts":53}],52:[function(a,b,c){var d=(a("./game_opts"),function(a,b,c){var d;for(this.qty=18,this.speed=20,this.color=c,this.rectangle=[],this.active=[],this.aliveShips=this.qty,this.direction=0,startx=a,dist=60,d=0;d<this.qty;d++)this.rectangle[d]={x:a,y:b,w:30,h:30},a+=dist,0!=d&&(d+1)%6==0&&(b+=dist,a=startx);for(d=0;d<this.qty;d++)this.active[d]=1});d.prototype.moveX=function(a){for(i=0;i<this.qty;i++)this.rectangle[i].x+=a},d.prototype.moveLeft=function(){this.moveX(-this.speed)},d.prototype.moveRight=function(){this.moveX(this.speed)},d.prototype.moveY=function(a){this.rectangle.y+=a},d.prototype.getX=function(){return this.rectangle.x},d.prototype.getY=function(){return this.rectangle.y},d.prototype.getW=function(){return this.rectangle.w},d.prototype.getH=function(){return this.rectangle.h},d.prototype.asignBullet=function(a){this.bullet=a},d.prototype.fire=function(){var a=-1,b=0,c=this.getRandomInt(0,this.aliveShips+1);for(c-=1,i=0;i<this.qty;i++)if(this.active[i]&&a++,a==c){b=i;break}this.bullet.fire(this.rectangle[b].x+this.rectangle[b].w/2,this.rectangle[b].y+this.rectangle[b].h/2),0==this.bullet.orientation?this.bullet.orientation=1:this.bullet.orientation=0},d.prototype.getRandomInt=function(a,b){return Math.floor(Math.random()*(a-b+1))+b},d.prototype.draw=function(a){var b;for(b=0;b<this.qty;b++)this.active[b]&&(a.fillStyle=this.color,a.fillRect(this.rectangle[b].x,this.rectangle[b].y,this.rectangle[b].w,this.rectangle[b].h))},d.prototype.getState=function(){if(0==this.aliveShips){for(i=0;i<this.qty;i++)this.active[i]=1;this.aliveShips=this.qty}return{x:this.rectangle[0].x,y:this.rectangle[0].y,active:this.active}},d.prototype.setState=function(a){var b,c,d,e;for(this.active=a.active,c=a.x,d=a.y,b=c,e=60,i=0;i<this.qty;i++)this.rectangle[i]={x:c,y:d,w:30,h:30},c+=e,0!=i&&(i+1)%6==0&&(d+=e,c=b)},b.exports=d},{"./game_opts":53}],53:[function(a,b,c){var d={screenW:800,screenH:600};b.exports=d},{}],54:[function(a,b,c){var d=a("./space_battle"),e=a("socket.io-client"),f=$("#fps"),g=function(a,b){var c,d=(new Date).getTime(),b=b||50,e=1e3/b,g=+new Date;return function b(h){requestAnimationFrame(b);var i=(new Date).getTime(),j=i-d;j>e&&(c=1e3/(h-g),g=h,f.text(Math.round(c,10)),d=i-j%e,a())}(0)},h=config.server;socket=e.connect(h),console.log("conecting to "+h),console.log(socket);var i=document.getElementById("canvas"),j=i.getContext("2d"),k={};location.search.substr(1).split("&").forEach(function(a){k[a.split("=")[0]]=a.split("=")[1]}),console.log(k.id),socket.emit("gameId",{id:k.id}),console.log("gameId t: "+Date.now());var l=new d(socket);window.addEventListener("keydown",function(a){l.keyPressed(a)},!0),window.addEventListener("keyup",function(a){l.keyUp(a)},!0);var m=0;setInterval(function(){l.handleMove(m),m++},30),g(function(){l.draw(j)},48);var n=$("#latency");socket.on("state",function(a){console.log(a),l.setState(a.s),l.commands[a.last]&&(n.text(Date.now()-l.commands[a.last]),delete l.commands[a.last])})},{"./space_battle":56,"socket.io-client":2}],55:[function(a,b,c){var d=a("./game_opts"),e=function(a,b,c){this.rectangle={x:a,y:b,w:60,h:40},this.speed=20,this.color=c,this.bullet=!1};e.prototype.moveX=function(a){a<0&&this.rectangle.x+a<0||a>0&&this.rectangle.x+this.rectangle.w+a>d.screenW||(this.rectangle.x+=a)},e.prototype.moveLeft=function(){this.moveX(-this.speed)},e.prototype.moveRight=function(){this.moveX(this.speed)},e.prototype.moveY=function(a){this.rectangle.y+=a},e.prototype.getX=function(){return this.rectangle.x},e.prototype.getY=function(){return this.rectangle.y},e.prototype.getW=function(){return this.rectangle.w},e.prototype.getH=function(){return this.rectangle.h},e.prototype.asignBullet=function(a){this.bullet=a},e.prototype.fire=function(){this.bullet.fire(this.getX()+this.getW()/2,this.getY())},e.prototype.draw=function(a){a.fillStyle=this.color,a.fillRect(this.getX(),this.getY(),this.getW(),this.getH())},e.prototype.getState=function(){return{x:this.rectangle.x,y:this.rectangle.y}},e.prototype.setState=function(a){this.rectangle.x=a.x,this.rectangle.y=a.y},b.exports=e},{"./game_opts":53}],56:[function(a,b,c){var d=(a("./game_opts"),a("./ship")),e=a("./bullet"),f=a("./fleet"),g=a("./barrier"),h=a("./bonus"),k=function(a){this.KEYCODE_LEFT=37,this.KEYCODE_RIGHT=39,this.KEYCODE_UP=38,this.KEYCODE_DOWN=40,this.lastMessage=0,this.commands={},this.commands[0]=Date.now(),this.socket=a,this.actors=[],this.collisions=[],this.ship1=new d(370,10,"#0BFFF5"),this.ship2=new d(370,500,"pink"),this.b1=new e(-10,-10,"grey"),this.b2=new e(-10,-10,"grey"),this.b2.orientation=1,this.ship1.asignBullet(this.b1),this.ship2.asignBullet(this.b2),this.fleet=new f(240,200,"#AF90FF"),this.b3=new e(-10,-10,"#AF90FF"),this.b3.speed=15,this.fleet.asignBullet(this.b3),this.bar1=new g(150,70,"#35FFCF"),this.bar2=new g(150,430,"#35FFCF",!0),this.bonus=new h(10,140,"red"),this.actors.push(this.ship1),this.actors.push(this.ship2),this.actors.push(this.b1),this.actors.push(this.b2),this.actors.push(this.fleet),this.actors.push(this.b3),this.actors.push(this.bar1),this.actors.push(this.bar2),console.log(this.bar2.rectangle.constructor===Array),"undefined"!=typeof window&&(this.owOgg=new Audio("/sounds/shot.ogg"));var b=this;this.registerCollision(this.b1,this.ship2,function(){b.b1.reset(),b.ship2.rectangle.x=0}),this.registerCollision(this.b1,this.fleet,function(a){b.fleet.active[a]=0,b.fleet.aliveShips--,b.b1.reset()}),this.registerCollision(this.b1,this.bar1,function(a){b.bar1.active[a]=0,b.b1.reset()}),this.registerCollision(this.b1,this.bar2,function(a){b.bar2.active[a]=0,b.b1.reset()}),this.registerCollision(this.b2,this.ship1,function(){b.b2.reset(),b.ship1.rectangle.x=0}),this.registerCollision(this.b2,this.fleet,function(a){b.fleet.active[a]=0,b.fleet.aliveShips--,b.b2.reset()}),this.registerCollision(this.b2,this.bar1,function(a){b.bar1.active[a]=0,b.b2.reset()}),this.registerCollision(this.b2,this.bar2,function(a){b.bar2.active[a]=0,b.b2.reset()}),this.registerCollision(this.b3,this.ship1,function(){b.b3.reset(),b.ship1.rectangle.x=0}),this.registerCollision(this.b3,this.ship2,function(){b.b3.reset(),b.ship2.rectangle.x=0}),this.registerCollision(this.b3,this.bar2,function(a){b.bar2.active[a]=0,b.b3.reset()}),this.registerCollision(this.b3,this.bar1,function(a){b.bar1.active[a]=0,b.b3.reset()})};k.prototype.startFleet=function(){var a=this;setInterval(function(){a.moveFleet()},800);var b=0;setInterval(function(){clearInterval(b),b=setInterval(function(){0==a.bonus.direction?a.bonus.moveX(a.bonus.speed):a.bonus.moveX(-a.bonus.speed)},50),0==a.bonus.direction?a.bonus.direction=1:a.bonus.direction=0},8500)},k.prototype.moveFleet=function(){0==this.fleet.direction?this.fleet.rectangle[0].x<420?this.fleet.moveX(2*this.fleet.speed):this.fleet.direction=1:this.fleet.rectangle[0].x>50?this.fleet.moveX(2*-this.fleet.speed):this.fleet.direction=0,this.fleet.fire()},k.prototype.draw=function(a){for(a.clearRect(0,0,800,600),i=0,l=this.actors.length;i<l;i++)this.actors[i].draw(a)},k.prototype.handleMove=function(a){var b;b=Date.now(),this.left?(this.socket.emit("moved",{t:b,i:this.lastMessage,direction:"left"}),this.commands[this.lastMessage]=b,this.lastMessage++):this.right&&(this.socket.emit("moved",{t:b,i:this.lastMessage,direction:"right"}),this.commands[this.lastMessage]=b,this.lastMessage++)},k.prototype.keyPressed=function(a){switch(a.keyCode){case this.KEYCODE_LEFT:this.left=!0;break;case this.KEYCODE_RIGHT:this.right=!0;break;case 32:0==this.ship1.bullet.state&&(this.owOgg.play(),this.socket.emit("fired",{}))}a.preventDefault(),a.stopPropagation()},k.prototype.keyUp=function(a){switch(a.keyCode){case this.KEYCODE_LEFT:this.left=!1;break;case this.KEYCODE_RIGHT:this.right=!1;break;case this.KEYCODE_UP:this.up=!1;break;case this.KEYCODE_DOWN:this.down=!1}},k.prototype.getState=function(){var a=[];this.handleCollisions();for(var b=0,c=this.actors.length;b<c;b++)a.push(this.actors[b].getState());return a},k.prototype.setState=function(a){for(var b=0,c=a.length;b<c;b++)null!=a[b]&&this.actors[b].setState(a[b])},k.prototype.check_collision=function(a,b){var c,d,e,f,g,h,i,j;return c=a.x,e=a.x+a.w,g=a.y,i=a.y+a.h,d=b.x,f=b.x+b.w,h=b.y,j=b.y+b.h,!(i<=h)&&(!(g>=j)&&(!(e<=d)&&!(c>=f)))},k.prototype.registerCollision=function(a,b,c){var d=this;this.collisions.push(function(){if(1==a.state)if(b.rectangle.constructor===Array)for(i=0,j=b.rectangle.length;i<j;i++)1==b.active[i]&&d.check_collision(a.rectangle,b.rectangle[i])&&c(i);else d.check_collision(a.rectangle,b.rectangle)&&c()})},k.prototype.handleCollisions=function(){for(i=0;i<this.collisions.length;i++)this.collisions[i]();1==this.b2.state,1==this.b1.state,1==this.b3.state},b.exports=k},{"./barrier":49,"./bonus":50,"./bullet":51,"./fleet":52,"./game_opts":53,"./ship":55}]},{},[54]);